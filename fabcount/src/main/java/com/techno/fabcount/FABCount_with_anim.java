 ...
 */
public class FABCount_with_anim extends FloatingActionButton {
    ...
    public FABCount_with_anim(Context context) {
        this(context, null, 0);
    }

    public FABCount_with_anim(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public FABCount_with_anim(Context context, AttributeSet attrs, int defStyleAttr) {
...
*/
    ...
    private static class SavedState extends BaseSavedState {
        ...
        /**
         * Constructor called from {@link FABCount_with_anim#onSaveInstanceState()}
         */
        ...
        public String toString() {
            return FABCount.class.getSimpleName() + "." + SavedState.class.getSimpleName() + "{"
                    + Integer.toHexString(System.identityHashCode(this))
                    + " count=" + count + "}";
        }*/

        public static final Creator<SavedState> CREATOR
                = new Creator<FABCount_with_anim.SavedState>() {
            public FABCount_with_anim.SavedState createFromParcel(Parcel in) {
                return new FABCount_with_anim.SavedState(in);
            }

            public FABCount_with_anim.SavedState[] newArray(int size) {
                return new FABCount_with_anim.SavedState[size];
            }
        };
    }
